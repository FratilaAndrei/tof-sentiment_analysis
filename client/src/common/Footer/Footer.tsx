...
const Footer = () => {
    return <div className="h-[165px] bg-gradient-to-br from-orange-500 to-yellow-500 flex mt-20">
...
{/* TODO: Make the swiper and put all of these into an object array */}
            ...
            <div className="h-1/2 text-white flex justify-between items-center">  
                <img 
                    src={Continental} 
                    alt="Continental logo" 
                    className="aspect-[3/2] object-contain max-h-[80px]"
                />
                <img 
                    src={nttData}
                    alt="NTT Data logo" 
